    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="data-form" class="pl-3 pr-3">
          <div class="row">
          <input type="hidden" id="id_disciplina" name="id_disciplina" class="form-control" placeholder="Id_disciplina" maxlength="11" required>
						</div>
						<div class="row">
							<div class="col-md-12">
              ...
              <div class="col-md-12">
								<div class="form-group mb-3">
									<label for="horas" class="col-form-label"> Carga horária: <span class="text-danger">*</span> </label>
									<input type="number" id="horas" name="horas" class="form-control" placeholder="Carga horária" minlength="0"  maxlength="11" required>
								</div>
							</div>
						</div>
...
// Fim - preenchimento dos selects
  ...
  function save(id_disciplina) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    $('#horas').prop('disabled', true);
    $('#horas').prop('value', 0);
    $('#tipologia_id').prop('disabled', true);
    if (typeof id_disciplina === 'undefined' || id_disciplina < 1) { //add
