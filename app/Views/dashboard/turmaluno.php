        ...
        <div class="card-header">
          <div class="row">
            <div class="col-10 mt-2">
              <h3 class="card-title">turmaluno</h3>
            </div>
            <div class="col-2">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="anoletivo_id" class="col-form-label"> Anoletivo id: </label>
									<input type="number" id="anoletivo_id" name="anoletivo_id" class="form-control" placeholder="Anoletivo id" minlength="0"  maxlength="11" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="turma_id" class="col-form-label"> Turma id: </label>
									<input type="number" id="turma_id" name="turma_id" class="form-control" placeholder="Turma id" minlength="0"  maxlength="11" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
