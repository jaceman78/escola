    ...
    <ul class="navbar-nav ms-auto">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="d-flex">
              <div class="flex-shrink-0">
                <img src="<?= base_url('img/user.jpg') ?>" alt="User Avatar" class="img-size-50 img-circle me-3">
              </div>
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
          <img src="<?= base_url('img/user.jpg') ?>" class="user-image img-circle shadow" alt="User Image">
          <span class="d-none d-md-inline">Alexander Pierce</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="<?= base_url('img/user.jpg') ?>" class="img-circle shadow" alt="User Image">
